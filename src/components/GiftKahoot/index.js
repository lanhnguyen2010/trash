...
const GiftKahootView = ({selectedGift, history, endFlow}) => (
...
const GiftKahoot = withStyles(styles)(GiftKahootView);

const GiftKahootContainer = compose(
  connect(
    selectors.root,
    {
...
export default GiftKahootContainer;
